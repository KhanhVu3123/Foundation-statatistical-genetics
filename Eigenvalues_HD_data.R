# Main theme: Simulation to show that if p >> n, then the variance covariance matrix becomes noiser and noisier, which leads to increasing proportion of negative (or very close to 0) eigenvalues.

# Generate some very high dimensional data (50 data points with p features)
...
# For our toy examples of 50 observations, as long as p >>n, it will produce a lot of negative or close to 0 eigenvalues, which will affect our inverse matrix estimation
